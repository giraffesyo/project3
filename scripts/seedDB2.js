...
const tiposdeestudioSeed = [
  ...
  },
  {
    clave: "201",
    nombretipodeestudio: "NOM-043-SEMARNAT-1993",
    descripcion:"Estudio isocinético de partículas y Voc's por cromatografía de gases",
    nombrerama:"Fuentes Fijas",
    metodos:[
      "EPA MÉTODO 18"
    ]
  },
  {
    clave: "202",
    nombretipodeestudio: "NOM-043-SEMARNAT-1993",
    descripcion:"Estudio isocinético de partículas y Voc's por ionización de flama",
    nombrerama:"Fuentes Fijas",
    metodos:[
      "EPA MÉTODO 25-A"
    ]
...
db.Ramas.remove({}).then(() => db.Tipodeestudio.remove({})).then(() => db.Metodos.remove({}))
.then(() => db.Signatarios.remove({})).then(() => db.Equipos.remove({}))
